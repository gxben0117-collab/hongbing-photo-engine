...
function generateXianxia(core, data) {
  const selection = {
    ...
    composition: 'centered luxury commercial portrait composition, clean premium poster layout, subject as the hero visual',
    framing: 'threeQuarter',
    intensity: 'balanced xianxia styling, elegant robe and ribbon movement, refined spiritual atmosphere',
...
function generateAnime(core, data) {
  const selection = {
    ...
    framing: 'fullBody',
    intensity: 'dynamic battle action, sweeping hair and costume movement, high-energy anime key visual',
...
function generateFlowerFairy(core, data) {
  const selection = {
    ...
    framing: 'threeQuarter',
    intensity: 'balanced floral fantasy styling, graceful wing and petal movement, refined fairy editorial presence',
    pose: 'hold_flower',
    style: 'luxury',
    camera: 'eyeLevelCover',
    ratio: '4:5',
...
function generateIsekai(core, data) {
  const selection = {
    ...
    composition: 'centered commercial key visual, subject placed in the middle of the frame, balanced advertising layout',
    framing: 'threeQuarter',
    intensity: 'balanced fantasy adventure styling, graceful cloak movement, refined worldbuilding presence',
...
function generateFloralSweet(core, data) {
  const selection = {
    ...
    composition: 'centered commercial key visual, subject placed in the middle of the frame, balanced advertising layout',
    framing: 'threeQuarter',
    intensity: 'balanced romantic styling, lively natural movement, refined floral details',
...
function generateGalaSocialite(core, data) {
  const selection = {
    ...
    composition: 'centered commercial key visual, subject placed in the middle of the frame, balanced advertising layout',
    framing: 'threeQuarter',
    intensity: 'balanced couture styling, controlled garment movement, refined jewelry presence',
    pose: 'center_still',
    style: 'galaCampaign',
    camera: 'eyeLevelCover',
    ratio: '4:5',
...
function generateAncientGoddess(core, data) {
  const selection = {
    ...
    composition: 'centered commercial key visual, subject placed in the middle of the frame, balanced advertising layout',
    framing: 'threeQuarter',
    intensity: 'balanced ceremonial grandeur, graceful fabric movement, refined mythic presence',
...
function generateKpopIdol(core, data, selectionOverride = null) {
  const selection = {
    ...
    composition: 'centered commercial key visual, subject placed in the middle of the frame, balanced advertising layout',
    framing: 'threeQuarter',
    intensity: 'balanced performance energy, natural body movement, refined idol stage presence',
    pose: 'center_still',
...
function generateBattleAcademy(core, data) {
  const selection = {
    ...
    composition: 'centered commercial key visual, subject placed in the middle of the frame, balanced advertising layout',
    framing: 'threeQuarter',
    intensity: 'balanced academy combat readiness, controlled uniform movement, polished action portrait energy',
