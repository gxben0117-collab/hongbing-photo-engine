...
const sectionOrders = {
  ...
  'magazine.html': ['section-preset', 'section-style', 'section-theme', 'section-garment-variation', 'section-details', 'section-body', 'section-pose', 'section-framing', 'section-background', 'section-motion', 'section-camera', 'section-ratio', 'section-media', 'section-output'],
  ...
  'extreme-sports.html': ['section-preset', 'section-style', 'section-sport', 'section-action', 'section-garment', 'section-garment-variation', 'section-body', 'section-pose', 'section-extra', 'section-lighting', 'section-background', 'section-camera', 'section-ratio', 'section-output'],
  ...
  'chinese-bridal.html': ['section-preset', 'section-style', 'section-composition', 'section-garment', 'section-material', 'section-garment-variation', 'section-veil', 'section-body', 'section-pose', 'section-styling', 'section-lighting', 'section-background', 'section-extra', 'section-camera', 'section-ratio', 'section-output'],
