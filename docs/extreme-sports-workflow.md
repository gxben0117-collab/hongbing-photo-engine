...
頁面專屬核心要求：高速快門凝結一個決定性瞬間；人物、器材、地形與運動方向保持物理合理；水花、雪霧、塵土與衣物反應要服務動作，不得變成無關裝飾。衝浪與滑雪另有頁面專屬「環境反應尺度」：衝浪允許高聳浪壁、寬幅浪花與前中景飛沫，滑雪允許高而密的粉雪爆散、雪霧尾流與前景雪晶；效果可以更大、更有速度感，但不得遮住臉部、主要身體、器材接觸點或運動方向。高風險動作以合理安全裝備與可讀接觸面呈現。
